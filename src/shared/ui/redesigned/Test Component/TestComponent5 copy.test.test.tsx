...
import { TestComponent5 copy.test } from './TestComponent5 copy.test';

describe('TestComponent5 copy.test', () => {
  it('should render without crashing', () => {
    render(<TestComponent5 copy.test />);
  ...
  it('should render with provided props', () => {
    ...
    render(<TestComponent5 copy.test {...testProps} />);
